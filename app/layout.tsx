...
export const metadata: Metadata = {
  ...
  description:
    "نخبة من المعلمين والمعلمات المتميّزين في جدة والرياض — تأسيس للمناهج البريطانية والأمريكية، وبرامج القدرات والتحصيلي، ومتابعة لجميع المواد والمراحل، إضافة إلى التخاطب وصعوبات التعلم.",
