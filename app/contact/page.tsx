...
const FAQS = [
  ...
  },
  {
    ...
    a: "نعم. الحصة الأولى تعارف وتقييم، وإن شعرت الأسرة أن الأسلوب لا يناسب الطالب نرشّح معلمة أخرى دون تعقيد.",
  },
  {
    q: "هل تخدمون مدنًا أخرى غير جدة والرياض؟",
    a: "حضوريًا نعمل حاليًا في جدة والرياض فقط. أما الحصص الأونلاين فمتاحة لأي مدينة في المملكة، وهي خيار عملي للمواد الحسابية وبرامج القدرات و STEP.",
  },
];

export const metadata: Metadata = pageMetadata({
  title: "تواصل معنا",
  description: `تواصل مع ${BRAND.nameAr} عبر واتساب أو الاتصال المباشر لترشيح معلمة مناسبة في جدة أو الرياض — حصص منزلية أو أونلاين لجميع المواد والمراحل.`,
  path: "/contact",
});
    ...
    <>
      ...
      <section className="mx-auto max-w-content px-4 py-10">
        ...
        <p className="mt-5 max-w-3xl text-lg leading-9 text-slate-600">
          ...
          ونرشّح لك معلمة مناسبة من الشبكة. لا يوجد تسجيل ولا نماذج طويلة — رسالة واحدة تكفي.
        </p>
          ...
          <ol className="mt-6 grid gap-4 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                d: "نختار من الشبكة معلمة متخصّصة في المادة والمرحلة، وقريبة من موقعكم إن كانت الحصص منزلية.",
              },
              {
                t: "٣. حصة تعارف وتقييم",
                d: "الحصة الأولى لتقييم المستوى ووضع خطة، ثم يُتّفق على جدول ثابت للحصص.",
              },
            ].map((s) => (
